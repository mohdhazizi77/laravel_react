                            ...
                            <Col lg={6}>
                                <CardBody className="border-end">
                                    <div className="search-box">
                                        <input type="text" className="form-control bg-light border-light" autoComplete="off" id="searchList" onChange={(e) => handleChange(e)} placeholder="Search candidate..." />
                                        <i className="ri-search-line search-icon"></i>
                                    </div>
                                    <SimpleBar style={{ maxHeight: "190px" }} className="px-3 mx-n3">
                                        {
                                            !searchdata ?
                                                ecommerceWidget.map((item) =>
